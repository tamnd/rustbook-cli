...
Most of these come down to network reality or how rustbook serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

rustbook rate-limits like any public site. rustbook already paces
...
Where a surface is gated, rustbook reads a cookie or token you supply
...
`rustbook`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what rustbook actually did
