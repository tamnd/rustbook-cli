...
// HTTP behaviour is covered in rustbook_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "rustbook://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("rustbook", "about")
	if err != nil || got.String() != "rustbook://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want rustbook://page/about", got.String(), err)
	}
}
